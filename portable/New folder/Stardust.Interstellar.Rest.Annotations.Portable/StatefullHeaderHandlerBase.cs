...
namespace Stardust.Interstellar.Rest.Extensions
{
    public abstract class StatefullHeaderHandlerBase : IHeaderHandler
    {
        ...
        public void SetHeader(IRequestWrapper req)
        {
        ...
        protected abstract void DoSetHeader(StateDictionary state, IRequestWrapper req);

        /// <summary>
        /// Get header values form a service response
        /// </summary>
        /// <param name="response"></param>
        public void GetHeader(IResponseWrapper response)
        {
            try
            {
        ...
        protected abstract void DoGetHeader(StateDictionary state, IResponseWrapper response);
