...
namespace Stardust.Interstellar.Rest.Extensions
{
    public static class StateHelper
    {
        ...
        public static void InitializeState(this IRequestWrapper req)
        {
            GetState(req);
        }

        public static void EndState(this IResponseWrapper response)
        {
        ...
        public static StateDictionary GetState(this IRequestWrapper req)
        {
        ...
        public static StateDictionary GetState(this IResponseWrapper response)
        {
            var actionId = response.ActionId();
            return InitializeState(actionId);
        }

        public static string ActionId(this IRequestWrapper request)
        {
            return request.Headers[ActionIdName];
        }

        public static string ActionId(this IResponseWrapper response)
        {
