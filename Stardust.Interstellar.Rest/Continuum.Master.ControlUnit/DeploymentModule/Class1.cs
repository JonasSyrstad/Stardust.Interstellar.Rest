...
using DeploymentMode = Microsoft.Azure.Management.ResourceManager.Models.DeploymentMode;
...
namespace PortalGenerated
{
    ...
    {
        internal string subscriptionId = "your-subscription-id";
        internal string clientId = "your-service-principal-clientId";
        internal string clientSecret = "your-service-principal-client-secret";
        internal string resourceGroupName = "resource-group-name";
        internal string deploymentName = "deployment-name";
        internal string resourceGroupLocation = "resource-group-location"; // must be specified for creating a new resource group
        internal string pathToTemplateFile = "path-to-template.json-on-disk";
        internal string pathToParameterFile = "path-to-parameters.json-on-disk";
        internal string tenantId = "tenant-id";
